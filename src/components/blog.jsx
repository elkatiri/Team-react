      ...
      <div className="blog">
        ...
        <div className="body_blog">
          ...
          <div className="blog_content">
            ...
            <p className="content">
              Welcome to <span>Furniro</span>, where style meets quality in
              every piece of furniture we create. At <span>Furniro</span> , we
              believe that furniture is more than just functional it’s an
              essential part of what makes a house feel like home. That’s why we
              are dedicated to offering a diverse range of thoughtfully
              designed, high-quality furniture that combines comfort,
